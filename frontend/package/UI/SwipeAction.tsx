...
export function SwipeAction({ children, actionContent, onAction }: any) {
  return (
    <div className="relative overflow-hidden w-full h-full group">
      <div
        className="absolute inset-y-0 right-0 w-24 bg-error-bg text-error-text border-l border-error-border flex items-center justify-center translate-x-full group-hover:translate-x-0 transition-transform cursor-pointer"
        onClick={onAction}
      >
