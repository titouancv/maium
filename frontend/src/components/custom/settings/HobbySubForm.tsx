...
export const HobbySubForm = ({ initialData, onSave, onCancel, onDelete }: Props) => {
  ...
  return (
    ...
    >
      <form id={SIGNUP_FORM_ID} onSubmit={handleSubmit(onSave)} className="flex flex-col gap-4">
        <TextInput placeholder={t("hobbyTitlePlaceholder")} autoFocus {...register("title")} />
        <TextArea placeholder={t("hobbyDescriptionPlaceholder")} {...register("description")} />
      </form>
    </StepLayout>
  );
};
