...
> {
  const system = [
    ...
    "- title: the action, imperative, max 8 words (e.g. 'Revise Kubernetes operators').",
    "- detail: 1 to 2 sentences saying why this matters for THIS job and what to focus on.",
    "- kind: 'technical' for a hard skill or tool, 'soft' for a behavioural or communication skill, 'company' for knowledge about the company, its product, market or culture.",
    "- The set MUST contain at least one 'soft' point and at least one 'company' point. The rest are 'technical'.",
    "- resource_query: 2 to 6 words IN ENGLISH, phrased as a real YouTube or Google search on the underlying topic. No company name, no candidate name, no full sentence. Good: 'kubernetes operators tutorial', 'star method behavioral interview'. Bad: 'how to prepare for the job at Acme'.",
    "- resource_kind: 'video' when the topic is a skill best seen performed or demoed, 'article' when it is a concept, a method, or industry context.",

    "### recruiter_questions",
    "An array of 3 to 5 PLAIN STRINGS. Each element is the question text itself — never an object, never {\"question\": \"...\"}.",
    "These are questions the candidate should ASK the recruiter at the end of the interview.",
    "- Derive each one from the job posting: product, team, stack, roadmap, challenges, ways of working.",
    "- Each question must be specific enough that it could not be asked about any other job.",
    "- Never ask about salary, holidays, remote policy, or benefits.",
    ...
    '{ "scores": { "hard_skills": 0.0, "seniority": 0.0, "semantic": 0.0, "bonus": 0.0 }, "prep_points": [{ "title": "", "detail": "", "kind": "technical", "resource_query": "", "resource_kind": "video" }], "recruiter_questions": ["question text", "question text"], "summary": "" }',
    "- kind is exactly one of: technical, soft, company. resource_kind is exactly one of: video, article. Never any other value.",
